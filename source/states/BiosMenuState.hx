...
class BiosMenuState extends MusicBeatState {
	...
	var descFile:DescFile;

	override function create() {

		descFile = Json.parse(Paths.getTextFromFile('bios/desc.json'));
		...
		imagePath = CoolUtil.coolTextFile(Paths.getPath('bios/imagePath.bios'));

		// DESCRIPTION HERE
        //charDesc = ["This is a description text.", "This is a description text.", "This is a description text."];

		charDesc = descFile.DescArray;

		// NAME HERE
        //charName = ["Sample", "Name 2", "Name 3"];

		charName = CoolUtil.coolTextFile(Paths.getPath('bios/charName.bios'));
