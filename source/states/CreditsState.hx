...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Sketchbook Engine Credits'],
			['Omegatchi',			'omegatchi',			'Engine idea and team leader',								 'https://www.youtube.com/channel/UC6ycjmhEqJB6MUQ9rLmIBqw',									'FFDD33'],
			['AceSpades',			'acespades',			'Main engine developer',								 'https://www.youtube.com/@0AceSpades0',									'FFDD33'],
			['DRABBLE',			'grunge',			'Adding shit for shits n giggles while playtesting the engine',								 '',									'FFDD33'],
			['P-Slice Engine Team'],
