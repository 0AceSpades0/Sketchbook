...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if LEGACY_PSYCH
		scoreText = new FlxText(10, 10, 0, 'LEVEL SCORE: '+FlxStringUtil.formatMoney(lerpScore, false, true), 36);
		#else
		scoreText = new FlxText(10, 10, 0, Language.getPhrase('week_score', 'LEVEL SCORE: {1}', [FlxStringUtil.formatMoney(lerpScore, false, true)]), 36);
		#end
	...
	override function update(elapsed:Float)
	{
		...
		if(intendedScore != lerpScore)
		{
			...
			#if LEGACY_PSYCH
			scoreText.text = 'LEVEL SCORE: ${FlxStringUtil.formatMoney(lerpScore, false, true)}';
			#else
